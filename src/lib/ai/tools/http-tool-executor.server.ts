...
import { assertJsonSchemaValue } from "@/lib/ai/tools/json-schema.server";
import { requestTemplateSchema, type RuntimeHttpToolConfig, type ToolExecutionContext } from "@/lib/ai/tools/dynamic-tool-types";
